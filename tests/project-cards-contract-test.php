...
$assert(str_contains($board_page, 'project_render_board_kanban('), 'Board page must render the kanban through the shared component.');
$assert(str_contains($board_page, 'project_render_modal_templates('), 'Board page must render modal templates.');
$assert(str_contains($surface, 'function project_render_board_kanban'), 'Board surface must expose the kanban renderer.');
