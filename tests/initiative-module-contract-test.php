...
foreach (["modal.style.height = '90vh'", "body.className = 'min-h-0 flex-1 p-5 overflow-y-auto overscroll-contain'", "body.style.minHeight = '0'", 'focus({preventScroll: true})'] as $needle) {
