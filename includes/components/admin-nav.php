<?php
/**
 * Compact admin navigation shared by workspace admin pages.
 */
...
$admin_nav_groups = [
    ...
    [
        ...
        'items' => [
            ...
            'initiatives' => ['label' => t('Initiatives'), 'icon' => 'lightbulb'],
            'initiative-approvals' => ['label' => t('Initiative approvals'), 'icon' => 'check'],
